...
import type { CharacterConfig, CharacterTheme, CharacterType } from '../types/characterTypes';
...
export const getCharacterTheme = (characterType: CharacterType): CharacterTheme => {
  ...
  return {
    ...
    icon: React.createElement(IconComponent, { className: "w-20 h-20 text-white" })
  };
};
...
export const getCharacterDisplayName = (characterType: CharacterType): string => {
